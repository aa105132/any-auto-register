...
const DEFAULT_FORM: Record<string, any> = {
  ...
  swarms_registration_mode: 'protocol',
...
export default function Register() {
  ...
  const submit = async () => {
    ...
    const extra: Record<string, any> = {
      ...
      phone_provider: form.identity_provider === 'phone' ? 'haozhu' : (form.phone_provider || 'haozhu'),

      phone_otp_timeout: Number(form.phone_otp_timeout || 180),

      phone_project_id: String(form.phone_project_id || '').trim(),

      haozhu_project_id: String(form.phone_project_id || '').trim(),

      grok_registration_mode: form.platform === 'grok' ? (form.grok_registration_mode || 'browser') : undefined,

      swarms_registration_mode: form.platform === 'swarms' ? (form.swarms_registration_mode || 'protocol') : undefined,
  ...
  const sourceModeLabel = seedLines.length > 0 ? '种子文本驱动' : '批量数量驱动'

  void sourceModeLabel
  ...
  return (
    ...
    <div className="page-enter space-y-4">
      ...
      <section className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-raised)] px-5 py-4">

        <div className="flex flex-wrap items-center justify-between gap-3">

          <div>

            <div className="workspace-kicker">注册编排</div>

            <h1 className="mt-1 text-[var(--text-2xl)] font-semibold tracking-tight text-[var(--color-text)]">自动注册任务</h1>
      ...
      {/* Main: Left (config) + Right (task/log) */}
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1.2fr)_minmax(300px,0.8fr)]">
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardHeader className="flex-row items-center justify-between space-y-0">
              ...
              <div>
                ...
                <div className="workspace-kicker">基础配置</div>

                <CardTitle className="mt-1">任务参数</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-3 md:grid-cols-2">
                ...
                <RegisterSelect form={form} onSet={set} label="平台" k="platform" options={platformOptions} helper="选择目标站点" />

                <RegisterTextInput form={form} onSet={set} label="并发数" k="concurrency" type="number" helper="同时运行的任务数，1=单线程" />
              ...
              <div>
                ...
                <div className="flex rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-0.5 mb-3">
                  ...
                  <button
                    ...
                    className={`flex-1 rounded px-3 py-1.5 text-xs font-medium transition-colors ${!seedLines.length ? 'bg-[var(--color-accent-muted)] text-[var(--color-text)]' : 'text-[var(--color-text-muted)] hover:text-[var(--color-text)]'}`}
                  ...
                  <button
                    ...
                    className={`flex-1 rounded px-3 py-1.5 text-xs font-medium transition-colors ${seedLines.length > 0 ? 'bg-[var(--color-accent-muted)] text-[var(--color-text)]' : 'text-[var(--color-text-muted)] hover:text-[var(--color-text)]'}`}
                ...
                {seedLines.length > 0 ? (
                  ...
                  <RegisterTextInput form={form} onSet={set} label="批量数量" k="count" type="number" helper="要注册的账号总数" />
          ...
          <details className="group" open={false}>
            ...
            <summary className="cursor-pointer list-none rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-raised)] px-5 py-3.5 flex items-center justify-between">
              ...
              <div>
                ...
                <span className="ml-3 text-xs text-[var(--color-text-muted)]">
                  ...
                  身份: {summaryRegistration} · 执行: {summaryExecutor}

                  {form.identity_provider === 'mailbox' ? ` · 邮箱: ${currentMailboxProvider?.label || form.mail_provider}` : ''}
              ...
              <span className="text-xs text-[var(--color-text-muted)] hidden group-open:inline">收起</span>
            ...
            <div className="mt-4 space-y-4">
              ...
              <Card>
                ...
                <CardHeader>
                  ...
                  <div className="workspace-kicker">Step 1</div>

                  <CardTitle className="mt-1">注册身份</CardTitle>
                    ...
                    {registrationOptions.map((option) => {
                      ...
                      return (
                        ...
                        <button
                          ...
                          className={`rounded-lg border px-4 py-3 text-left transition-colors ${active ? 'border-[var(--color-accent)] bg-[var(--color-accent-muted)]' : 'border-[var(--color-border)] bg-[var(--color-surface)] hover:border-[var(--color-accent)]/60'}`}
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 text-sm font-medium text-[var(--color-text)]">
                            ...
                            {active && <span className="ml-auto text-[11px] text-[var(--color-accent-text)]">当前</span>}
              ...
              {isTwoApiPushPlatform && (
                ...
                <Card>
                  ...
                  <CardHeader>
                    ...
                    <div className="workspace-kicker">{twoApiPushPlatformLabel} 输出</div>

                    <CardTitle className="mt-1">{twoApiPushPlatformLabel} 注册完成后 2API 推送</CardTitle>
                        ...
                        return (
                          ...
                          <button
                            ...
                            className={active
                              ...
                              ? 'rounded-lg border border-[var(--color-accent)] bg-[var(--color-accent-muted)] px-4 py-3 text-left transition-colors'
              ...
              <Card>
                ...
                <CardHeader>
                  ...
                  <div className="workspace-kicker">Step 2</div>

                  <CardTitle className="mt-1">执行通道</CardTitle>
                ...
                <CardContent>
                    ...
                    {executorOptions.map((option) => {
                      ...
                      return (
                        ...
                        <button
                          ...
                          className={`rounded-lg border px-3 py-3 text-left transition-colors ${option.disabled ? 'cursor-not-allowed opacity-40 border-[var(--color-border)]' : active ? 'border-[var(--color-accent)] bg-[var(--color-accent-muted)]' : 'border-[var(--color-border)] bg-[var(--color-surface)] hover:border-[var(--color-accent)]/60'}`}
                    ...
                    <div className="mt-4 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                      ...
                      <div className="mt-3 grid gap-3 md:grid-cols-2">
                        ...
                        {[
                          ...
                          ['protocol', '协议注册', '不打开浏览器，走 Swarms Server Action + 邮箱验证；速度快，但可能需要后续浏览器登录才刷新额度。'],

                          ['browser', '可视浏览器注册', '打开浏览器真实提交注册、邮箱验证后创建 API Key；更接近原站行为，适合本地 Windows 拿 $5。'],

                        ].map(([value, label, description]) => {

                          const active = (form.swarms_registration_mode || 'protocol') === value
                      ...
                      <div className="mt-3 text-[11px] text-[var(--color-text-muted)]">可视浏览器注册会强制使用“可视浏览器自动”执行通道；关闭窗口或取消任务会导致本次注册失败。</div>
                  ...
                  {form.platform === 'grok' && form.identity_provider === 'mailbox' && form.executor_type === 'cdp_protocol' && (
                    ...
                    <div className="mt-4 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-4">
                      ...
                      <div className="mt-3 text-[11px] text-[var(--color-text-muted)]">默认推荐完整浏览器注册；只有需要复现旧协议链路时再切到协议混合。</div>
                          ...
                          <div className="md:col-span-2 rounded-md border border-[var(--color-border)] bg-[var(--color-surface-raised)] p-3">
                            ...
                            <div className="mt-2 grid gap-3 lg:grid-cols-3">
                              ...
                              <button
                                ...
                                className={`rounded-lg border px-4 py-3 text-left transition-colors ${currentGoogleAccountMode === 'purchase' ? 'border-[var(--color-accent)] bg-[var(--color-accent-muted)]' : 'border-[var(--color-border)] bg-[var(--color-surface)] hover:border-[var(--color-accent)]/60'} ${!hstockplusProvider ? 'cursor-not-allowed opacity-50' : ''}`}
                              ...
                              <button
                                ...
                                className={`rounded-lg border px-4 py-3 text-left transition-colors ${currentGoogleAccountMode === 'pool' ? 'border-[var(--color-accent)] bg-[var(--color-accent-muted)]' : 'border-[var(--color-border)] bg-[var(--color-surface)] hover:border-[var(--color-accent)]/60'} ${!hstockplusProvider ? 'cursor-not-allowed opacity-50' : ''}`}
                              ...
                              <button
                                ...
                                className={`rounded-lg border px-4 py-3 text-left transition-colors ${currentGoogleAccountMode === 'chrome' ? 'border-[var(--color-accent)] bg-[var(--color-accent-muted)]' : 'border-[var(--color-border)] bg-[var(--color-surface)] hover:border-[var(--color-accent)]/60'}`}
                            ...
                            {currentGoogleAccountMode === 'purchase' ? (
                              ...
                              <div className="mt-4 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-3">
                                ...
                                <div className="mt-2 text-[11px] text-[var(--color-text-muted)]">这里是新购 Google/Gmail 账号的配置；交付后账号会自动写入 Google 账号池。</div>
                              ...
                              <div className="mt-4 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] p-3">
                                ...
                                <div className="mt-2 text-[11px] text-[var(--color-text-muted)]">要用截图里的账号，就把邮箱填到这里：lexivioletanubvht0013@ffcfd.cfd。系统会读取池内密码，不需要你手填密码。</div>
              ...
              {form.identity_provider === 'phone' && (
                ...
                <Card>
                  ...
                  <CardHeader>
                    ...
                    <div className="workspace-kicker">手机号注册</div>

                    <CardTitle className="mt-1">接码项目</CardTitle>
                  ...
                  <CardContent>
                    ...
                    {optionsError && (
                      ...
                      <div className="mb-4 rounded-md border border-red-500/20 bg-red-500/10 px-3 py-2 text-xs text-red-300">{optionsError}</div>

                    )}

                    <div className="grid gap-3 md:grid-cols-2">

                      <RegisterTextInput form={form} onSet={set} label="项目 ID" k="phone_project_id" placeholder="例如 114190" />
                    ...
                    <div className="mt-3 rounded-md border border-[var(--color-border)] bg-[var(--color-surface-hover)] px-3 py-2 text-xs text-[var(--color-text-muted)]">
                      ...
                      默认使用豪猪接码。GetToken 手机号注册已实测纯协议可用；这里只需要填豪猪项目 ID。
              ...
              {form.identity_provider === 'mailbox' && (
                ...
                <Card>
                  ...
                  <CardHeader>
                    ...
                    <div className="workspace-kicker">邮箱</div>

                    <CardTitle className="mt-1">邮箱来源</CardTitle>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {optionsError && (
                      ...
                      <div className="rounded-md border border-red-500/20 bg-red-500/10 px-3 py-2 text-xs text-red-300">{optionsError}</div>
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          ...
                          {mailboxProviderOptions.filter(([v]: any) => v !== form.mail_provider).map(([value, label]: any) => {
                            ...
                            return (
                              ...
                              <label key={value} className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[11px] cursor-pointer transition-colors ${checked ? 'bg-[var(--color-accent-muted)] text-[var(--color-accent-text)]' : 'bg-[var(--color-surface)] text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-hover)]'}`}>
        ...
        <div className="space-y-4">
          ...
          <Card className="xl:sticky xl:top-4">
            ...
            <CardHeader>
              ...
              <div className="workspace-kicker">提交任务</div>

              <CardTitle className="mt-1">执行注册</CardTitle>
                ...
                {summaryTiles.map(({ label, value, icon: Icon }) => (
                  ...
                  <div key={label} className="flex items-center gap-2.5 rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2.5">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-sm font-medium text-[var(--color-text)] truncate">{value}</div>
          ...
          {task ? (
            ...
            <>
              ...
              <Card>
                ...
                <CardHeader className="flex-row items-center gap-2 space-y-0">
                  ...
                  <Badge variant={TASK_STATUS_VARIANTS[task.status] || 'secondary'}>{getTaskStatusText(task.status)}</Badge>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="rounded-md border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2">
                    ...
                    <div className="text-xs font-mono text-[var(--color-text)] break-all">{task.id}</div>
              ...
              <Card>
                ...
                <CardHeader>
                  ...
                  <div className="workspace-kicker">实时日志</div>

                  <CardTitle className="mt-1">执行日志</CardTitle>
            ...
            <Card>
              ...
              <CardHeader>
                ...
                <div className="workspace-kicker">等待执行</div>

                <CardTitle className="mt-1">任务状态与日志</CardTitle>

              </CardHeader>

              <CardContent>

                <div className="empty-state-panel">提交任务后将在这里显示状态和日志。</div>

...
class ConfigService:
    def __init__(
        ...
        resin_runtime: ResinRuntime | None = None,
    ):
        ...
        self.resin_runtime = resin_runtime or ResinRuntime()
    ...
    def check_resin(self, data: dict[str, object] | None = None, *, task_platform: str = "") -> dict:
        merged = {
            **self.repository.get_flat(),
            **{key: value for key, value in dict(data or {}).items()},
        }
        return self.resin_runtime.probe(merged, task_platform=task_platform)
    ...
    def get_options(self) -> dict:
        return {
            ...
            "phone_drivers": self.provider_definitions.list_driver_templates("phone"),
            ...
            "phone_providers": self.provider_definitions.list_definitions("phone", enabled_only=True),
            "phone_settings": self.provider_settings.list_settings("phone"),
        }

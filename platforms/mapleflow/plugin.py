...
@register
class MapleFlowPlatform(BasePlatform):
    name = "mapleflow"
    display_name = "MapleFlow"
    version = "1.0.0"
    ...
    def _run_oauth(self, ctx) -> dict:
        from platforms.mapleflow.browser_oauth import register_with_browser_oauth
    ...
    def _map_result(self, result: dict) -> RegistrationResult:
        ...
        return RegistrationResult(
            ...
            extra={
                ...
                "auth_url": "https://api.mapleflow.io/auth/google",

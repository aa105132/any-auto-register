...
@register
class AnyAPIPlatform(BasePlatform):
    name = "anyapi"
    display_name = "AnyAPI"
    version = "1.0.0"
    ...
    def _run_oauth(self, ctx) -> dict:
        from platforms.anyapi.browser_oauth import register_with_browser_oauth
    ...
    def _map_result(self, result: dict) -> RegistrationResult:
        ...
        return RegistrationResult(
            ...
            extra={
                ...
                "dashboard_token": str(result.get("dashboard_token") or ""),
